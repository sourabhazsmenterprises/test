...
color: #000;
 					    ...
 					    <form method="POST" id="register-form" action="{{ url('doctorsregisterssubmit') }}">
            @csrf
...
<div class="container mt-3" style=" ">
    	<div class="row">
			<div class="col-md-6 col-md-offset-3 m-auto">
                ...
                <div class="register-show" id="register-show">
                    <h2 style="color:#000;" id="register-show1">DOCTOR REGISTER</h2>
	 ...
	 {{session('mymsg231')}}
				  ...
				  <div class="row">
                     <div class="col-md-6">
					<input type="text" placeholder="Name" name="name" id="register-show6" required style="color:black;  " onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)  ||  (event.charCode==32) ">
					  </div>
					   <div class="col-md-6">
					<input type="email" placeholder="Email" name="email"   required style="color:black;  "  > 
					  </div>
					   <div class="col-md-6">
					<input type="text" placeholder="Mobile" name="mobile" required style="color:black;  " onkeypress="return (event.charCode >47 && event.charCode < 58)    ||  (event.charCode==32) " >
						     </div>
					   <div class="col-md-6">
					     <input type="text" placeholder="Qualification" name="qualification"   required style="color:black;  "  >
						     </div>
					   <div class="col-md-6">
					  <input type="text" placeholder="Present address" name="present_address"   required style="color:black;  "  >
						     </div>
					   <div class="col-md-6">
					 <input type="text" placeholder="Permnent Address" name="permanent_address"   required style="color:black;  "  >
					 
					
					     </div>
					   <div class="col-md-6">
					 <input type="text" placeholder="Pan" id="Pan" name="pan" style="color:black; "    required>
					 </div>
						  
						  <div class="col-md-6">
							   <input type="text" placeholder="Indian medical council reg id"   name="reg_id" style="color:black;  " required  onkeypress="return (event.charCode >47 && event.charCode < 58)    ||  (event.charCode==32) "  >
							 
						 </div>
					   <div class="col-md-12">
							 
							  <label>Addhar Image</label>
							 <input type="file" placeholder="Aadhar card" maxlength="10" name="aadhar_image" style="color:black;  " required    >
						 </div>
