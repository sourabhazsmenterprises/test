 ...
 <section class="content">
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12" style="text-align:right;">
            <a class="btn btn-success" href="{{ url('admin/hospitals/create') }}">
               Add Hospitals
            </a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td> {{$value->name}} </td> 
                     ...
                     <td>
                                    ...
                                    <a class="btn btn-xs btn-primary" href="{{ url('admin/hospitals/show', $value->id) }}">
                                        <i class="fa fa-eye"></i>
                                    </a>
                              
                                    <a class="btn btn-xs btn-info" href="{{ url('admin/hospitals/edit', $value->id) }}">
										<i class="fa fa-edit"></i>
                                    </a>
                             
                                    <form action="{{ url('admin/hospitals/destroy', $value->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@parent
  ...
  let deleteButton = {
    ...
    url: "{{ url('admin/hospitals/massDestroy') }}",
