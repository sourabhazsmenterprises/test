		...
		<section class="contact-title text-center">
			<div class="contact-wrapper">
				<div class="container">
					<div class= "row">
						<div>
							<h1 class="headline">Chat Direct</h1>
						</div>
					</div>
					<div class="row">
				...
				<div class="col-md-4 col-xl-3 chat"><div class="card mb-sm-3 mb-md-0 contacts_card">
					<div class="card-header">
						<div class="input-group">
							<input type="text" placeholder="Search..." name="" class="form-control search" style="background-color: transparent;color: white;border:2px solid #384f5e;">
					...
					<div class="card-body contacts_body">
						<ui class="contacts">
							<li   >
								<h3 style="color:white;">Dotors List </h3>
							</li>
					...
					<div class="card">
						<div class="card-header msg_head">
							<div class="d-flex bd-highlight">
								...
								<div class="user_info">
									<span>Chat with Doctors khalid</span>
									<p>1767 Messages</p>
								</div>
								<div class="video_cam">
						...
						<div class="card-footer">
							<div class="input-group">
								<div class="input-group-append">
									<span class="input-group-text attach_btn"><i class="fas fa-paperclip" style="font-size:18px;"></i></span>
								</div>
								<textarea name="" class="form-control type_msg" placeholder="Type your message..." style="font-size:18px;"></textarea>
								<div class="input-group-append">
									<span class="input-group-text send_btn"><i class="fas fa-location-arrow" style="font-size:18px;"></i></span>
								</div>
							</div>
						</div>
					</div>
