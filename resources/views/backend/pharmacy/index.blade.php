 ...
 <section class="content">
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12" style="text-align:right;">
            <a class="btn btn-success" href="{{ url('admin/pharmacy/create') }}">
               Add Pharmacy
            </a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td> {{$value->name}} </td> 
                     ...
                     <td>
                                    ...
                                    <a class="btn btn-xs btn-primary" href="{{ url('admin/pharmacy/show', $value->id) }}">
                                        <i class="fa fa-eye"></i>
                                    </a>
                              
                                    <a class="btn btn-xs btn-info" href="{{ url('admin/pharmacy/edit', $value->id) }}">
										<i class="fa fa-edit"></i>
                                    </a>
                             
                                    <form action="{{ url('admin/pharmacy/destroy', $value->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@parent
  ...
  let deleteButton = {
    ...
    url: "{{ url('admin/pharmacy/massDestroy') }}",
